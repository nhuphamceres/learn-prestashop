...
require_once(dirname(__FILE__).'/AdminCDiscountProductsController.inc.php');

class AdminCDiscountProductsController extends ModuleAdminController
{
    const SUB_CONTROLLER = 'AdminCDiscountProductsControllerExt';
    ...
    public function __construct()
    {
        ...
        $this->productController = new $subcontroller();
    ...
    public function renderForm()
    {
        ...
        $html = $this->productController->content($this->context->smarty);
