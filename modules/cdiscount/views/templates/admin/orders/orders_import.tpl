...
{if $tab_import_data}
    <div id="conf-import" class="tabItem {$tab_import_data.selected_tab|escape:'htmlall':'UTF-8'} form-horizontal"
         rel="update">
        <h3 style="text-align:center;margin:10px 0 0 0; border: none;">{l s='Import Orders' mod='cdiscount'}</h3>
        ...
        <form action="{$tab_import_data.request_uri|escape:'htmlall':'UTF-8'}" method="post" id="import-orders-form">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="margin-form col-lg-9">
                        <input type="text" name="datepickerFrom" id="datepickerFrom"
                               value="{$tab_import_data.start_date|escape:'htmlall':'UTF-8'}" style="margin-left:5px">
                        <span class="import-dt">&nbsp;{l s='To' mod='cdiscount'}&nbsp;&nbsp;</span>
                        <input type="text" name="datepickerTo" id="datepickerTo"
                               value="{$tab_import_data.current_date|escape:'htmlall':'UTF-8'}"><br>
                        <br>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-lg-3">{l s='Order Status' mod='cdiscount'}</label>

                    <div class="margin-form col-lg-9">
                        <select name="orders-statuses" style="margin-left:5px;width:250px;" id="orders-statuses">
                            <option value="Importable">{l s='Ready to be Imported' mod='cdiscount'}</option>
                            <option value="All">{l s='All Pending Orders' mod='cdiscount'}</option>
                        </select><br>
                        <br>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="margin-form col-lg-9">
                        <input type="hidden" id="import-orders-url"
                               value="{$tab_import_data.import_orders_url|escape:'htmlall':'UTF-8'}"/>
                        <input type="button" id="import-orders" value="{l s='Lookup' mod='cdiscount'}"
                ...
                <div class="form-group">
                    <div class="margin-form col-lg-12">
                        ...
                        <div class="{$alert_class.success|escape:'htmlall':'UTF-8'}" id="import-orders-result"
                             style="display:none"></div>
                        <br/>

                        <div class="{$alert_class.danger|escape:'htmlall':'UTF-8'}" id="import-orders-error"
                             style="display:none"></div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="margin-form col-lg-9">
                        <input type="hidden" name="token_order"
                               value="{$tab_import_data.token_orders|escape:'htmlall':'UTF-8'}"/>
                        <input type="hidden" id="import-order-url"
                               value="{$tab_import_data.import_order_url|escape:'htmlall':'UTF-8'}"/>
                        <input type="button" id="import-order" value="{l s='Import Selected Orders' mod='cdiscount'}"
                               class="button btn"/>
                        <input type="hidden" id="text-select-orders"
                               value="{l s='Please select one or more orders to import !' mod='cdiscount'}"/>
                    </div>
                </div>
