...
class AdminAmazonProductsController extends ModuleAdminController
{
    ...
    public function renderForm()
    {
        ...
        if ((bool)$amazon_features['wizard']) {
        ...
        $this->context->smarty->assign('creation', $amazon_features['creation']);
        $this->context->smarty->assign('expert_mode', $amazon_features['expert_mode']);
        $this->context->smarty->assign('import_products', $amazon_features['import_products']);
        ...
        $this->context->smarty->assign('repricing', $amazon_features['repricing']);
        $this->context->smarty->assign('ps17x', $this->ps17x);
        ...
        $this->context->smarty->assign('matching_box', $this->path.'views/templates/admin/items/matching_box.tpl');
        $this->context->smarty->assign('wizard_enabled', (bool)$amazon_features['wizard']);
        ...
        $html .= $this->context->smarty->fetch($this->path.'views/templates/admin/AdminCatalogAmazon.tpl');
