...
class AdminAmazonOrdersController extends ModuleAdminController
{
    ...
    public function languageSelector()
    {
        ...
        $debugInfo .= sprintf('Europe: %s', print_r($europe, true).Amazon::LF);
        $debugInfo .= sprintf('Features: %s', print_r($amazon_features, true).Amazon::LF);
        $debugInfo .= sprintf('Actives: %s', print_r($actives, true).Amazon::LF);
        $debugInfo .= sprintf('Regions: %s', print_r($regions, true).Amazon::LF);
        $debugInfo .= sprintf('Marketplace Ids: %s', print_r($marketPlaceIds, true).Amazon::LF);

        $this->context->smarty->assign('debugInfo', $debugInfo);

        $html .= $this->context->smarty->fetch($this->path.'views/templates/admin/items/debug_orders.tpl');
