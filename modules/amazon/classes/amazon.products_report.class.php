...
class AmazonProductsReport extends Amazon
{
    ...
    protected $debugFilePrefix = 'amazon.products_report.class';
    ...
    protected function reportRequest()
    {
        ...
        if (!$xml instanceof SimpleXMLElement) {
            $this->edd(sprintf('ReportRequest Failed - %s', print_r($xml, true)), __LINE__);
            return false;
        } elseif (isset($xml->Error)) {
            $this->edd(sprintf('ReportRequest Failed - %s', print_r($xml->Error->Message, true)), __LINE__);
            return false;
        }
    ...
    protected function reportRequestList()
    {
        ...
        if (!$xml instanceof SimpleXMLElement) {
            printf('%s(#%d): reportRequestList Failed: %s'.Amazon::LF, basename(__FILE__), __LINE__, $xml);
            return (false);
        }
        if (isset($xml->Error)) {
