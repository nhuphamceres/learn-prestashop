                ...
                if ($item['InStockSupplyQuantity'] == 0) {
                    ...
                    if ($options['fba']) {
                        ...
                        foreach ($targets_id_lang as $marketplace_id_lang) {
                            AmazonProduct::updateProductOptions($product->id, $marketplace_id_lang, 'fba', false, $product->id_product_attribute, false);
                        }
                    }
                    ...
                    if (!$options['fba']) {
                        ...
                        foreach ($targets_id_lang as $marketplace_id_lang) {
                            AmazonProduct::updateProductOptions($product->id, $marketplace_id_lang, 'fba', true, $product->id_product_attribute, false);
                        }
                    }
