                ...
                if ($quantityConsidered == 0) {
                    ...
                    if ($options['fba'] || $forceUpdate) {
                        ...
                        foreach ($targets_id_lang as $marketplace_id_lang) {
                            ...
                            $value = max($ignore_fba_value, $options['fba_value']);

                            AmazonProduct::updateProductOptions($product->id, $marketplace_id_lang, 'fba', $value, $product->id_product_attribute, false);
                    ...
                    if ($product->id_product_attribute) {
                        ...
                        $master_options = AmazonProduct::getProductOptions($product->id, $id_lang);
                    }
                    if (!$options) {
