...
<table id="total-tab" width="100%">
	...
	<tr>
		<td class="grey" width="50%">
			{l s='Total Products' d='Shop.Pdf' pdf='true' mod='amazon'}
		</td>
	...
	{if $footer.product_discounts_tax_excl > 0}
		...
		<tr>
			<td class="grey" width="50%">
				{l s='Total Discounts' d='Shop.Pdf' pdf='true' mod='amazon'}
			</td>
			<td class="white" width="50%">
	...
	{if $footer.wrapping_tax_excl > 0}
		<tr>
			<td class="grey">
				{l s='Wrapping Costs' d='Shop.Pdf' pdf='true' mod='amazon'}
			</td>
	...
	<tr class="bold">
		<td class="grey">
			{l s='Total (Tax excl.)' d='Shop.Pdf' pdf='true' mod='amazon'}
		</td>
		<td class="white">
	...
	<tr class="bold">
		<td class="grey">
			{l s='Total Tax' d='Shop.Pdf' pdf='true' mod='amazon'}
		</td>
		<td class="white">
	...
	<tr class="bold big">
		<td class="grey">
			{l s='Total' d='Shop.Pdf' pdf='true' mod='amazon'}
		</td>
		<td class="white">
