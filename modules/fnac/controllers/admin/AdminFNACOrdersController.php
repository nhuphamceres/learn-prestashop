...
require_once(dirname(__FILE__).'/AdminFNACOrdersController.inc.php');

class AdminFNACOrdersController extends ModuleAdminController
{
    public $name = 'fnac';
    ...
    public function __construct()
    {
        ...
        $this->fnacOrdersController = new AdminFNACOrdersControllerExt($this->id_lang);
    ...
    public function renderForm()
    {
        ...
        $html = $this->fnacOrdersController->content($this->context->smarty);
