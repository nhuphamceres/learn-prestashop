...
//    protected static $productExport = array();
    ...
    {
        return array(
            'configuration' => CommonTools::pre(self::$configuration, true),
//            'product_export' => CommonTools::pre(self::$productExport, true),
//            'webservice' => CommonTools::pre(self::$webservice, true),
        );
    }
...
//    }
    ...
    protected function backTrace()
    {
        ...
        // Remove 2 first callers, self reference
