...
<input type="hidden" id="serror"
       value="{l s='A server-side error has occured. Please contact your server administrator, hostmaster or webmaster' mod='priceminister'}"/>
<input type="hidden" id="sdebug"
       value="{l s='You should click on this link to submit again in debug mode' mod='priceminister'}"/>
...
<fieldset class="panel">
    <h3>
        <img src="{$images|escape:'htmlall':'UTF-8'}logo.png" alt="" class="middle logo-circle"/> <span
                style="vertical-align: middle;"> {l s='Orders' mod='priceminister'}</span>
    </h3>
