...
require_once(dirname(__FILE__).'/AdminMiraklOrdersController.inc.php');

if (!class_exists('AdminMiraklOrdersController')) {
    class AdminMiraklOrdersController extends ModuleAdminController
    {
        public $name   = null;
        public $module = null;
        public $url;
        ...
        {
            $this->name = Tools::strtolower(preg_replace('/Admin(.*)Orders/', '$1', Tools::getValue('controller')));
            ...
            $this->mirakl_orders_controller = new AdminMiraklOrdersControllerExt($this->id_lang, $context_data, $this->name);
        }
        ...
        public function renderForm()
        {
            ...
            $html = $this->mirakl_orders_controller->content($this->context->smarty);
